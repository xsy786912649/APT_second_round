...
for observation_number in [1,2,4,8,12]:
    ...
    data_new3[:,1]=0
    data_new3[:,2]=data_new3[:,2]+0.3
    data_new3[:,3]=data_new3[:,3]+1.0
    ...
    data_new2=data_new2*0.7+data_new3*0.3
    ...
    plt.subplots_adjust(left=0.08, right=0.993, top=0.99, bottom=0.110)
